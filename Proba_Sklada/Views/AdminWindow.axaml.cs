...
public partial class AdminWindow : Window
{
    ...
    private async void EditProductButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            await ShowNotificationDialog("Âûáåğèòå òîâàğ äëÿ ğåäàêòèğîâàíèÿ.");
            return;
        }
        var db = App.Services.GetRequiredService<dbBaza>();
        ...
        if (existing == null)
        {
            await ShowNotificationDialog("Òîâàğ íå íàéäåí.");
            return;
        }
    ...
    private async void DeleteProductButton_Click(object sender, RoutedEventArgs e)
    {
        if (ProductsListBox.SelectedItem is not product selected)
        {
            await ShowNotificationDialog("Âûáåğèòå òîâàğ äëÿ óäàëåíèÿ.");
            return;
        }
        if (!await ConfirmAsync("Óäàëåíèå òîâàğà", "Âû äåéñòâèòåëüíî õîòèòå óäàëèòü âûáğàííûé òîâàğ?"))
            return;
    ...
    private async void EditCategoryButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            await ShowNotificationDialog("Âûáåğèòå êàòåãîğèş äëÿ ğåäàêòèğîâàíèÿ.");
            return;
        }
        var db = App.Services.GetRequiredService<dbBaza>();
        ...
        if (existing == null)
        {
            await ShowNotificationDialog("Êàòåãîğèÿ íå íàéäåíà.");
            return;
        }
    ...
    private async void DeleteCategoryButton_Click(object sender, RoutedEventArgs e)
    {
        if (CategoriesListBox.SelectedItem is not product_category selected)
        {
            await ShowNotificationDialog("Âûáåğèòå êàòåãîğèş äëÿ óäàëåíèÿ.");
            return;
        }
        if (!await ConfirmAsync("Óäàëåíèå êàòåãîğèè", "Âû äåéñòâèòåëüíî õîòèòå óäàëèòü âûáğàííóş êàòåãîğèş?"))
            return;
